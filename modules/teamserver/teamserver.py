...
class StdoutRedirector(io.StringIO):
    ...
    def write(self, s):
        self.text_widget.after(0, lambda: self._write_safe(s))

    def _write_safe(self, s):
...
class C2Gui(tk.Tk):
    def __init__(self):
        ...
        self.beacon_listbox = tk.Listbox(self, bg="#1e1e1e", fg="magenta", font=("Consolas", 12), selectbackground="#007acc", exportselection=False)
        ...
        self.console_text = ScrolledText(right_frame, bg="#000000", fg="#00ffff", font=("Consolas", 12))
