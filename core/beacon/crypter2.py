...
def step1():
    run_script("core/beacon/src/my_encoder.py", "build/beacon/beacon.py", "core/beacon/process/encoded1.txt")

def step2():
    run_script("core/beacon/src/my_builder.py", "core/beacon/process/encoded1.txt", "core/beacon/process/encoded1.py")
    
def step3():
    run_script("core/beacon/src/my_encoder.py", "core/beacon/process/encoded1.py", "core/beacon/process/encoded2.txt")

def step4():
    run_script("core/beacon/src/my_builder.py", "core/beacon/process/encoded2.txt", "core/beacon/process/encoded2.py")
...
def step9():
    run_script("core/beacon/src/base64_obf.py", "core/beacon/process/encoded5.py", "core/beacon/process/enc_beacon.py")
...
def print_result_path():
    file_path = os.path.abspath("core/beacon/process/enc_beacon.py")
